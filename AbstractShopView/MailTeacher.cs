...
{
    public static class MailTeacher
    {
        private static TcpClient mailTeacher;
        ...
        public static void Connect()
        {
            ...
            mailTeacher = new TcpClient();
            mailTeacher.Connect("pop.gmail.com", 995);

            stream = new SslStream(mailTeacher.GetStream());
